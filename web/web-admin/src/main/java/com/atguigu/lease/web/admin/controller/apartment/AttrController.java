...
public class AttrController {
    ...
    @Operation(summary = "新增或更新属性名称")//key
    ...
    @Operation(summary = "新增或更新属性值")//value
    ...
    @Operation(summary = "根据id删除属性名称")//key
    @DeleteMapping("key/deleteById")
    public Result removeAttrKeyById(@RequestParam Long attrKeyId) {
        attrKeyService.removeById(attrKeyId);
        //根据key删value
        attrValueService.remove(new LambdaQueryWrapper<>(AttrValue.class).eq(AttrValue::getAttrKeyId, attrKeyId));
        return Result.ok();
    }

    @Operation(summary = "根据id删除属性值")//value
